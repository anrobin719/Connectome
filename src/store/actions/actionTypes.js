...
export const APPLY_EXCHANGE_START = 'APPLY_EXCHANGE_START';
export const APPLY_EXCHANGE_SUCCESS = 'APPLY_EXCHANGE_SUCCESS';
export const APPLY_EXCHANGE_FAIL = 'APPLY_EXCHANGE_FAIL';
...
export const FETCH_APPLIED_DATA_SUCCESS = 'FETCH_APPLIED_DATA_SUCCESS';
export const FETCH_EXCHANGE_FAIL = 'FETCH_EXCHANGE_FAIL';

export const ACCEPT_BOOKING_START = 'ACCEPT_BOOKING_START';
